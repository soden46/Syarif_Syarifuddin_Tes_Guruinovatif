                    ...
                    <div class="card-body">
                        <form action="/insert" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="leader_name" class="form-control" id="leader_name">
                            </div>
                            <div class="mb-3">
                                <label for="leader_mail" class="form-label">Email</label>
                                <input type="email" name="leader_mail" class="form-control" id="leader_mail" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <label for="leader_photo" class="form-label">Masukkan foto leader</label>
                                <input type="file" name="leader_photo" class="form-control" id="leader_photo">
                            </div>
                            <div class="mb-3">
